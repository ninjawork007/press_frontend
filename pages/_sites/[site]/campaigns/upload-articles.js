      ...
      <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div>
            ...
            <h2 className="mt-6 text-5xl text-gray-900">
              Upload Your Articles
            </h2>
            <p>
              Upload your articles below and select outlets. <br /> You MUST
              provide one unique headline and article for each outlet purchased.
            </p>
            <a
            ...
            <>
              <span className="flex items-center flex-col justify-center space-y-2">
                ...
                <span className="font-medium text-gray-600">
                  Creating campaign and uploading your articles...
                </span>
              </span>
            </>
          ) : (
...
export const getServerSideProps = async (context) => {
  ...
  let purchasedPublications = await API.purchasedPublications
    .getForProfile({ profile_id: session?.profile?.id, only_show_unused: true })
    .then(function (result) {
      return result.data?.data;
