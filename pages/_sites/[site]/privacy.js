      ...
      <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl w-full space-y-8">
          <div className="container mx-auto flex-col px-6 max-w-7xl">
            <h1 className="text-left text-5xl">Privacy Policy</h1>
            <p className="mt-2">
              Your privacy is important to us. It is{" "}
              <span className="capitalize">{name}</span>&#39;s policy to respect
              ...
              <a href={websiteUrl}>{websiteUrl}</a>, and other sites we own and
              operate.{" "}
            </p>
            <p className="mt-2">
            ...
            <p className="mt-2">
              This policy is effective as of 12 October 2022.{" "}
            </p>
            <p className="mt-2">Last updated: 12 October 2022 </p>
            <br />
            ...
            <p className="mt-2">
              We consider &ldquo;user-generated content&rdquo; to be reviews,
              ratings, image, and/or video materials voluntarily supplied to us
              by our users for the purpose of publication on our website or
            ...
            <h3 className="text-xl">Children’s Privacy</h3>
            <p className="mt-2">
            ...
            <p className="mt-2">Third parties we currently use include: </p>
            <ul className="list-disc ml-4">
            ...
            <p className="mt-2">
              ...
              processing and fulfilling orders), we will not deny you goods or
            ...
            <h3 className="text-xl">Business Transfers</h3>
            <p className="mt-2">
            ...
            <h3 className="text-xl">Limits of Our Policy</h3>
            <p className="mt-2">
            ...
            <p className="mt-2">
              ...
              processors&rdquo;). We, <span className="capitalize">{name}</span>
              , located at the address provided in our Contact Us section, are a
              Data Controller with respect to the personal information you
              provide to us.{" "}
            </p>
            ...
            <p className="mt-2">
              ...
              You may provide a physical address for the purpose of receiving
              orders. While you may change or delete this address at any time,
              this will not affect orders that have already been sent. If you
