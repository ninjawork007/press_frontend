...
function Example({ siteData }) {
  ...
  const onSubmit = async (e) => {
    ...
    const result = await API.auth
      ...
      .then(() => {
        //TODO: this is kinda hacky and should be refactored
        //manually trigger send confirmation email again so we can access the profile on the backend
        return API.auth.sendConfirmation({
          email: form.email,
        });
      })
      .catch((err) => {
  ...
  return (
    <SiteWrapper siteData={siteData}>
      <div className="min-h-full flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center xl:flex-row gap-4 max-w-[390px] sm:max-w-[390px] md:max-w-[490px] lg:max-w-[1512px] xl:max-w-[1512px] space-y-8">
          {requiresConfirmation ? (
              ...
              <div className="space-y-6">
                <div className="flex flex-col items-center gap-4 justify-between">
                  ...
                  <div className="flex flex-col lg:flex-row gap-4 w-full justify-start">
                    ...
                    <a
                      className="button !py-4 !px-6 h-[56px] lg:w-[461px]"
            ...
            <>
              <div className="flex flex-col xl:min-w-[688px] xl:min-h-[432px]">
                ...
                <p className="mt-2 text-lg text-gray-600 text-left lg:text-center xl:text-left">
                  Create an account to start pitching to over 200+ publications
                </p>
